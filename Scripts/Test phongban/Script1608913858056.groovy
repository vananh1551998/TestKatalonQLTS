...
WebUI.setText(findTestObject('Object Repository/Themphongban/Page_Qun L Ti Sn DKC/input_Tn Ngi Dng_UserName'), 'BMT')

WebUI.setText(findTestObject('Object Repository/Themphongban/Page_Qun L Ti Sn DKC/input_Mt Khu_Password'), '12345')

WebUI.click(findTestObject('Object Repository/Themphongban/Page_Qun L Ti Sn DKC/button_ng Nhp'))

WebUI.click(findTestObject('Object Repository/Themphongban/Page_Trang Ch/p_Phng Ban'))
